...
const ADMIN_PATHS = [
  '/dashboard', '/store', '/clinic', '/client/journey/store', '/gri', '/market', '/point-a', '/point-b', '/simulator',
...
const CLIENT_DASHBOARD_PATHS = [
  '/dashboard', '/store', '/clinic', '/client/journey/store', '/gri', '/pulse', '/point-a', '/point-b', '/simulator',
