            ...
            <div className="flex items-start gap-4 flex-wrap">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1.5 flex-wrap mt-3">
                  ...
                  <span className="text-[10px] font-medium px-2 py-0.5 rounded-full bg-white/[0.05] border border-white/[0.06] text-on-surface-variant inline-flex items-center gap-1">
