        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button type="button" disabled title="Скоро" aria-label="LinkedIn — скоро"
                className="h-10 bg-surface-container/30 border border-white/[0.06] rounded-xl flex items-center justify-center gap-2 text-sm text-on-surface-variant/40 cursor-not-allowed">
