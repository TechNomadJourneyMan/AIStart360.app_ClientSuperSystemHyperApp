  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: t('total'), value: String(members.length), icon: 'group', note: t('activeProfiles') },
          { label: t('avgWorkload'), value: `${averageLoad}%`, icon: 'workspaces', note: t('acrossTeam') },
          { label: t('overloaded'), value: String(overloadedCount), icon: 'warning', note: t('needAttention') },
          { label: t('available'), value: String(availableCount), icon: 'check_circle', note: t('readyForTasks') },
        ].map((s) => (
