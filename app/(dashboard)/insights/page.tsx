    ...
    <div className="space-y-8">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-surface-container-low rounded-2xl border border-white/[0.04] p-6 hover:border-primary/20 transition-colors group">
          <div className="flex items-center justify-between mb-4">
            <p className="text-[10px] font-mono text-on-surface-variant uppercase tracking-widest">{t('griReports')}</p>
          ...
          <p className="text-[10px] font-mono text-primary mt-2 uppercase tracking-tight">{t('totalCalcCount')}</p>
        </div>
        <div className="bg-surface-container-low rounded-2xl border border-white/[0.04] p-6 hover:border-primary/20 transition-colors group">
          <div className="flex items-center justify-between mb-4">
            <p className="text-[10px] font-mono text-on-surface-variant uppercase tracking-widest">{t('avgGri')}</p>
          ...
          <p className="text-[10px] font-mono text-primary mt-2 uppercase tracking-tight">{t('scoreAcrossBase')}</p>
        </div>
      </section>
      ...
      <section>
        <div className="flex justify-between items-end border-b border-outline-variant/10 pb-4 mb-6">
          <div>
            <h2 className="font-headline text-lg font-bold text-on-surface">{t('allSignals')}</h2>
            <p className="text-xs text-on-surface-variant mt-1">{data.SIGNALS.length} {t('activeEvents')}</p>
          </div>
          <div className="hidden lg:flex gap-1.5">
            {[t('all'), t('market'), t('finance'), t('regulatory'), t('competitors')].map((f, i) => (
