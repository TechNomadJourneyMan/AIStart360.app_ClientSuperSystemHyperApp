    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <FieldLabel htmlFor="s1_industry">Industry (required)</FieldLabel>
          ...
          <div>
            <FieldLabel htmlFor="s1_stage">Development Stage</FieldLabel>
          ...
          <div>
            <FieldLabel htmlFor="s1_employee_count">Number of Employees</FieldLabel>
          ...
          <div>
            <FieldLabel htmlFor="s1_business_model">Business Model</FieldLabel>
          ...
          <div>
            <FieldLabel htmlFor="s1_years_on_market">Years on Market</FieldLabel>
          ...
          <div>
            <FieldLabel htmlFor="s1_website">Website</FieldLabel>
          ...
          <div className="md:col-span-2">
            <FieldLabel htmlFor="s1_social_media">Social Media</FieldLabel>
            <input id="s1_social_media" type="text" value={str(data.s1_social_media)} onChange={(e) => onChange('s1_social_media', e.target.value)} placeholder="Links to Instagram, Telegram, etc." className="w-full bg-surface-container border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-on-surface placeholder:text-on-surface-variant/30 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all" />
          </div>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <FieldLabel htmlFor="s1_products_list">List of Products / Services</FieldLabel>
            <textarea id="s1_products_list" rows={3} value={str(data.s1_products_list)} onChange={(e) => onChange('s1_products_list', e.target.value)} placeholder="List your main products or services..." className="w-full bg-surface-container border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-on-surface placeholder:text-on-surface-variant/30 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all resize-none" />
          </div>
          <div>
            <FieldLabel htmlFor="s1_competitors_list">Main Competitors</FieldLabel>
            <textarea id="s1_competitors_list" rows={3} value={str(data.s1_competitors_list)} onChange={(e) => onChange('s1_competitors_list', e.target.value)} placeholder="List your main competitors..." className="w-full bg-surface-container border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-on-surface placeholder:text-on-surface-variant/30 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all resize-none" />
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <FieldLabel htmlFor="s1_contact_name">Full Name (required)</FieldLabel>
            <input id="s1_contact_name" type="text" value={str(data.s1_contact_name)} onChange={(e) => onChange('s1_contact_name', e.target.value)} placeholder="John Doe" className="w-full bg-surface-container border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-on-surface placeholder:text-on-surface-variant/30 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all" />
          </div>
          <div>
            <FieldLabel htmlFor="s1_contact_position">Position</FieldLabel>
            <input id="s1_contact_position" type="text" value={str(data.s1_contact_position)} onChange={(e) => onChange('s1_contact_position', e.target.value)} placeholder="Director" className="w-full bg-surface-container border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-on-surface placeholder:text-on-surface-variant/30 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all" />
          </div>
          <div>
            <FieldLabel htmlFor="s1_contact_phone">Phone (required)</FieldLabel>
          ...
          <div>
            <FieldLabel htmlFor="s1_contact_email">Email (required)</FieldLabel>
