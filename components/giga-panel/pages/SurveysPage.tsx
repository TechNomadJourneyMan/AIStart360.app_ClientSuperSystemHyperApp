...
function SurveysInner() {
  ...
  return (
    <div>
      <PageHeader
        crumbs={[{ label, href: base }, { label: 'Анкеты' }]}
        title="Анкеты"
      ...
      <p className="mt-3 text-[11px] text-slate-600">Полный профиль пользователя — в разделе <Link href={`${base}/users`} className="text-blue-300 hover:underline">Пользователи</Link>.</p>
    </div>
  )
}
