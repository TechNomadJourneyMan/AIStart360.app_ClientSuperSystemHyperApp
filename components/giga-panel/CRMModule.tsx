  ...
  return (
    <div className="px-4 py-4 space-y-4">
      ...
      {data && data.completedSteps.length > 0 ? (
        ...
        <p className="text-[11px] text-slate-600 italic py-2">Survey not completed</p>
      ) : null}
    </div>
  )
}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-1.5">
                ...
                {hasSurvey && (
                  <span className="text-[8px] bg-emerald-500/15 text-emerald-400 px-1 py-0.5 rounded">Survey</span>
                )}
              </div>
  ...
  return (
    <div>
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-slate-100 tracking-tight">CRM / Users</h1>
          <p className="text-sm text-slate-500 mt-1">
            Account management, blocks, dashboard settings
          </p>
        </div>
        <motion.button
          onClick={fetchUsers}
                ...
                <th className="py-3 px-3 text-left">
                  <button
                    ...
                    className="flex items-center gap-1 text-[10px] font-semibold
                      text-slate-500 uppercase tracking-widest hover:text-slate-300 transition-colors"
                  >
                    Dates <SortIcon field="createdAt" />
                  </button>
                </th>
          ...
          <>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-slate-100">Block User?</h3>
                  <p className="text-xs text-slate-500 mt-0.5">{blockConfirm.name ?? blockConfirm.email}</p>
                </div>
              </div>
              <p className="text-xs text-slate-500 mb-5">
                The user session will be immediately revoked. This action can be undone later.
              </p>
